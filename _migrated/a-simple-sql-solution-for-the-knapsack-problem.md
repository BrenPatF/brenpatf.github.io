...
**Update, 14 July 2013**: I used the technique in response to another OTN post here, [SQL for the Fantasy Football Knapsack Problem](http://aprogrammerwrites.eu/?p=p=878). I have extended the idea there to allow for fast approximate solutions making it viable for larger problems, and have also used a similar idea here, [SQL for the Travelling Salesman Problem](http://aprogrammerwrites.eu/?p=p=896) (and in other articles).
